...
export function CardDetail({
    ...
    async (feedback: FeedbackData) => {
      try {
        ...
        toast({
          ...
          description:
            'Thank you for helping us improve our analysis!',
        });
      } catch (error) {
  ...
  const valuationHistory: ValuationHistoryDataPoint[] =
    React.useMemo(() => {
  ...
  return (
    <div className="space-y-6">
      <div className="grid gap-6 lg:grid-cols-[400px_1fr]">
        {/* Card Image Section */}
        <Card
          className="overflow-hidden border-[6px] border-emerald-400/70 hover:border-cyan-400 transition-all"
          style={{ boxShadow: '0 6px 25px rgba(16, 185, 129, 0.5)' }}
        >
            ...
            {comparableSales.length > 0 && (
              <div className="pt-2 border-t space-y-1.5">
                ...
                <div className="flex justify-between text-xs">
                  ...
                  <span className="font-medium">
                    {comparableSales.length} listings
                  </span>
                </div>
                <div className="flex justify-between text-xs">
                  <span className="text-[var(--muted-foreground)]">
                  ...
                  <span className="font-medium">
                    {Array.from(
                      new Set(comparableSales.map((s) => s.source))
                    ).join(', ')}
                  </span>
                </div>
              </div>
      ...
      {/* AI Insights - Prominent Feature */}
      {card.valuationSummary && (
        <AIInsights valuationSummary={card.valuationSummary} />
      )}
